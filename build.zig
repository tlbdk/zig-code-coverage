...
pub fn build(b: *std.Build) void {
    ...
    exe_mod.addImport("zig_code_coverage_lib", lib_mod);
    ...
    const debug_test_unit_step = b.step("debug-test-unit", "Debug unit tests");
    const install_debug_test_unit = b.addInstallArtifact(exe_unit_tests, .{
        .dest_sub_path = "debug-unit-tests",
    });
    debug_test_unit_step.dependOn(&install_debug_test_unit.step);
    ...
    cover_step.dependOn(&install_coverage.step);
}
